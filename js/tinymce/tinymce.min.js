    ...
    r(l, [], function () {
        ...
        return o = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (n) {
            function a() {
                ...
                for (e = e.replace(o, ""), u = d.getShortEndedElements(); c = t.exec(e); )
            ...
            return n.on("init", function () {
                ...
                e.isDefaultPrevented() || n.nodeChanged()
                    ...
                    if (e = e || {}, e.content = a(), p || n.removed)
                        return null;
                    if (o = u[c], n.fire("BeforeAddUndo", {level: e, lastLevel: o, originalEvent: t}).isDefaultPrevented())
                        return null;
                    if (o && o.content == e.content)
                        return null;
