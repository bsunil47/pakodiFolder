...
<div class="module module-login span4 offset4" style="margin:100px 410px;">
    <div align="center" class="success" style="margin:60px 0px"><?php echo $this->session->flashdata('msg'); ?></div> 
</div>
<?php }else{ ?>
<div class="module module-login span4 offset4">
    <?php echo form_open(base_url() . 'moderator/users/forgotpassword'); ?>
