    ...
    <div class="btn-controls">
        <div class="btn-box-row row-fluid" >
           <div class="span8" >
                <div class="row-fluid">
                    <div class="span12" >
                     <a href="javascript:void(0);"  class="btn-box small span4"><i class=" icon-group"></i><b><?php echo count($activeusers); ?></b>Active users</a>
                     <a href="javascript:void(0);"  class="btn-box small span4"><i class="icon-book"></i><b><?php echo count($contentcount); ?></b>Content Count</a>
                     <a href="javascript:void(0);"  class="btn-box small span4"><i class=" icon-download"></i><b><?php echo count($usercontentdownload); ?></b>Downloads</a>
						
                    </div>
                </div>
            </div>
            <a href="javascript:void(0);"  class="btn-box small span4" style="width:180px;"><i class=" icon-film"></i><b><?php echo count($userdubs); ?></b>Dubs</a>	
        </div>
    </div>
        ...
        <div class="btn-box-row row-fluid">
            <div class="module span12" style="width:800px;">
                <div class="module-head">
                    <h3>Categories</h3>
                    <p align="right"><input type="button" name="bar_chart" value="Bar" id="bar"><input type="button" name="bar_chart" value="Pie" id="pie"> </p>
		        </div>
            ...
            <div class="module span12" style="width:800px;">
                ...
                <form name="userstats" method="post">
                    ...
                    <div id="show2" class="hidz">
                        ...
                        <input type="button" id="btn_month" value="Go" onclick="return getusersbymonthly();">
                    </div>
                    <div id="show3" class="hidz" style="display: block;">
                        ...
                        <input type="button" id="btn_week" value="Go" onclick="return getusersbyweekly();">
                    </div>
                    <div id="show4" class="hidz">
                        ...
                        <input type="button" id="btn_day" value="Go" onclick="return getusersbydaily();">
                    </div>
                </form>
            ...
            <div class="module span12" style="width:800px;">
                ...
                <form name="dubstats" method="post">
                    ...
                    <div id="dshow2" class="hidz">
                        ...
                        <input type="button" id="btn_month" value="Go" onclick="return getdubsbymonthly();">
                    </div>
                    <div id="dshow3" class="hidz" style="display: block;">
                        ...
                        <input type="button" id="btn_week" value="Go" onclick="return getdubsbyweekly();">
                    </div>
                    <div id="dshow4" class="hidz">
                        ...
                        <input type="button" id="btn_day" value="Go" onclick="return getdubsbydaily();">
                    </div>
                </form>
