    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left"><h3>User Records</h3></td>
               </tr>
            </table>
        </div>
                  ...
                  ?>
                         <tr>
                           <td align="left"><?php echo $i+1; ?></td>
                                ...
                                <td align="left"><?php if(!empty($moderatorname)){echo $moderatorname->name;} ?></td>
                                <td align="left"><?php echo $status; ?></td>
                                <td align="left">
                                <a href="<?php echo base_url(); ?>moderator/users/updaterecstatus/<?php echo $dubbedusers[$i]->dub_id; ?>/<?php echo $dubbedusers[$i]->dub_status;?>">Status</a>&nbsp;&nbsp;
                                <a href="<?php echo base_url(); ?>moderator/users/update/<?php echo $dubbedusers[$i]->dub_id; ?>">Update</a>
                                </td>
                            </tr>
                     <?php
                        }
                     ...
                     ?>
                        <tr><td align="left" colspan="5">No Records Found</td></tr>
                    <?php
                    }
                    ?>
                </tbody>
