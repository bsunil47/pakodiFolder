...
<div class="sidebar">
 ...
 <li class= "<?php if ($this->router->fetch_class() == 'content' && ($this->router->fetch_method() == 'waitning' || $this->router->fetch_method() == 'add' || $this->router->fetch_method() == 'update' || $this->router->fetch_method() == 'view')) { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/content/waiting"><i class="menu-icon icon-book"></i>Waiting for Approval</a></li>
        ...
        <li class= "<?php if ($this->router->fetch_class() == 'alerts' && $this->router->fetch_method() == 'index') { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/alerts"><i class="menu-icon icon-flag"></i>Alerts</a></li>
   		<li class= "<?php if ($this->router->fetch_class() == 'dubscontent' && $this->router->fetch_method() == 'dubsupload') { ?>active<?php } ?>"><a href="<?php echo base_url(); ?>Admin/dubscontent/dubsupload"><i class="menu-icon icon-arrow-up"></i>Upload UGC Dubs</a></li>
		</ul>
</div>