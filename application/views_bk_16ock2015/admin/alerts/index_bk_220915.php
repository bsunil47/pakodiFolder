        ...
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    <td align="right"></td>
                    <td align="right">Device Type:

                        <select name="device_type" onchange="showdevicetypes(this.value)" id="dtype">
                            <option value="" >-Select-</option>
                            <option value="3" >IOS</option>
                            <option value="1" >Andriod</option>
                            <option value="2" >Both</option>
                        </select> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php base_url(); ?>alerts/add" ><button class='btn' title='Edit' style="border:1px solid #cccccc;">Add Alert</button></a>
