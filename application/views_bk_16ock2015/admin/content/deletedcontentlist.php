    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left"><h3>Rejected Content List</h3></td>
					...
					<select name="category"  id="catids">
        ...
        <div class="module-body table">
            <form name="date" method="post">
                ...
                <input type="button" name="delcontentsubmit" id="delcontentsubmit" value="Go" class="btn pakodi">
                <input type="button" id="delcontentreset" value="Reset" class="btn pakodi">
            </form>
