...
<div class="content">
    <div class="module">
        <div class="module-head"> <h3>Pakodi Sample window</h3></div>
...
//echo $this->session->userdata('recommend_value'); exit; ?>
                <div class="control-group">
					...
					<div class="controls" style="float:left;width:260px; margin-left:20px; padding:12px 0px; font-weight: bold;">Sample window</div>
					<div class="clear"></div>
                ...
                <div class="control-group">
                    <div class="controls">
						...
						<a href="javascript:window.history.go(-1);" class="btn pakodi" style="padding:3px;">Back</a>
                    </div>
                </div>
                        <div class="clear"></div>
