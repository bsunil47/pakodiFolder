...
<div class="sidebar">
    <ul class="widget widget-menu unstyled ">
        ...
        <li>
            <a class="<?php if ($this->router->fetch_class() != 'cms' && ($this->router->fetch_class() != 'content' && ($this->router->fetch_method() != 'index' && $this->router->fetch_method() != 'add' && $this->router->fetch_method() != 'update')) && ($this->router->fetch_class() != 'dubscontent') && ($this->router->fetch_class() != 'dubbedusers')) { ?>collapsed<?php } ?>"
            ...
            <ul id="togglePages5"
                ...
                <!--contentlist start-->
                <li>
                    <a class="<?php if (!($this->router->fetch_class() == 'content' && ($this->router->fetch_method() == 'index' || $this->router->fetch_method() == 'getwdetails' || $this->router->fetch_method() == 'add' || $this->router->fetch_method() == 'deletedcontentlist' || $this->router->fetch_method() == 'update' || $this->router->fetch_method() == 'waiting'))) { ?>collapsed<?php } ?>" data-toggle="collapse" href="#togglePages8">
                ...
                <!-- UGC list start-->
                <li>
                    <a class="<?php if ($this->router->fetch_class() != 'dubbedusers' && $this->router->fetch_class() != 'dubscontent') { ?>collapsed<?php } ?>" data-toggle="collapse" href="#togglePages6">
                ...
                <!-- Settings start-->
                <li>
                    <a class="<?php if (!($this->router->fetch_class() == 'content' && $this->router->fetch_method() == 'recommend') && ($this->router->fetch_class() != 'appversion') && ($this->router->fetch_class() != 'category') && ($this->router->fetch_class() != 'languages')) { ?>collapsed<?php } ?>"
                       data-toggle="collapse" href="#togglePages7"><i class="menu-icon fa fa-cogs"></i>
        ...
        <li>
            ...
            <a class="<?php if ($this->router->fetch_class() != 'alerts') { ?>collapsed<?php } ?>" href="#togglePages9" data-toggle="collapse">
            ...
            <ul id="togglePages9"
                ...
                <li class="<?php if ($this->router->fetch_class() == 'alerts' && $this->router->fetch_method() == 'birthdayalerts' || $this->router->fetch_method() == 'addbirthdayalert') { ?>active<?php } ?>">
                    <a href="<?php echo base_url(); ?>Admin/alerts/birthdayalerts"><i class="menu-icon fa fa-birthday-cake"></i>Birthday
                        Alerts</a>
                </li>
				<li class="<?php if ($this->router->fetch_class() == 'alerts' && $this->router->fetch_method() == 'commonusers' || $this->router->fetch_method() == 'addusers') { ?>active<?php } ?>">
                    <a href="<?php echo base_url(); ?>Admin/alerts/commonusers"><i class="menu-icon fa fa-users"></i>Common Users</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <a class="<?php if ($this->router->fetch_class() != 'creports') { ?>collapsed<?php } ?>" href="#togglePages14" data-toggle="collapse">
        ...
        <li>
            ...
            <a class="<?php if ($this->router->fetch_class() != 'ccreports' || $this->router->fetch_class() != 'loginusers') { ?>collapsed<?php } ?>" href="#togglePages15" data-toggle="collapse">
                <i class="menu-icon icon-table"></i>
                <i class="icon-chevron-down pull-right"></i>
