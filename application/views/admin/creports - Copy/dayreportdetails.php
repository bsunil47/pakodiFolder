                    ...
                    <div class="module-head">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td align="right"><?php if(isset($day_details_file)){?><a href="http://sprintmedia.s3.amazonaws.com/reports/<?php echo $day_details_file;?>" class='btn pakodi' >Export</a><?php }?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="clear"></div>
