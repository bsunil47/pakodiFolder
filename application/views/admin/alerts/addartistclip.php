<div class="content">
    <div class="module">
        <div class="module-head">
            <h3>Add Artist Clip</div>
        <div class="module-body">
            <form id="addauser" name="addauser" class="form-horizontal row-fluid" action="<?php echo base_url() . 'Admin/alerts/addartistclip'; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="module">
        <div class="module-head"> 
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left"><h3>Add Artist  Clip Excel</h3></td>
                    <td align="right"><a href="<?php echo base_url() . 'zipfiles/'?>artistclipsexcel.xlsx" class="btn pakodi">Sample Excel Download</a>
					</td>
                </tr>
            </table>
            </div>
        <div class="module-body">
            <form id="addeauser" name="addeauser" class="form-horizontal row-fluid" action="<?php echo base_url() . 'Admin/alerts/addartistclip'; ?>" method="post" enctype="multipart/form-data">

               <div class="control-group">
                    <label class="control-label" for="zip">Upload Zip File:</label>

                    <div class="controls">
                        <input type="file" name="zip" id="zip" placeholder="Upload Content Clip Excel">
