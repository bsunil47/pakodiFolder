                ...
                <div class="module span12">
                    <div class="module-head">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left"><h3><?php echo date('Y');?> Year- <?php $month=array('January','February','March','April','May','June','July','August','September','October','November','December');$i=$this->uri->segment(5); $j=$i-1;echo $month[$j];?> Month-<?php echo $this->uri->segment(6);?> Week <?php $report=array('Views','Downloads','Dubs','Share'); $k=$this->uri->segment(7); echo $report[$k];?> Report</h3>
                                </td>
                                <td align="right"><?php if(isset($week_details_file)){?><a href="http://sprintmediasg.s3.amazonaws.com/reports/<?php echo $week_details_file;?>" class='btn pakodi' >Export</a><?php }?><a href="javascript:window.history.go(-1);" style="float:right; display: inline-block" class="back-close btn pakodi">Back</a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="clear"></div>
