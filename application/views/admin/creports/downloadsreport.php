        ...
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    <td align="right"><a href="http://sprintmediasg.s3.amazonaws.com/reports/<?php if(isset($downloads_file)){echo $downloads_file;}?>?header=content-disposition:attachment;filename:<?php if(isset($downloads_file)){echo $downloads_file;}?>;" class='btn pakodi' target="_blank" download >Export</a><a href="javascript:window.history.go(-1);" style="float:right; display: inline-block" class="back-close btn pakodi">Back</a>
                    </td>
                </tr>
            </table>
                ...
                <tr style="background-color: #f6f6f6">
                    <form name="date" method="post" class="table-form">
                        ...
                        <td style="text-align: center">
                            <input type="submit" name="reportsubmit" id="reportsubmit" value="Search" class="btn pakodi" style="">
                        </td>
                    </form>
                </tr>
