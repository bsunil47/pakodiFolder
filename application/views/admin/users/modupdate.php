<div class="content">
    <div class="module">
        <div class="module-head"> <h3>Edit Moderator<span style="float:right; display: inline-block" class="back-close btn pakodi">Back</span></h3></div>
        <div class="module-body">
            <form id="updatemoderator" name="updatemoderator" method="post" action="<?php echo base_url(); ?>Admin/users/modupdate/<?php echo $users->id; ?>" class="form-horizontal row-fluid" >
