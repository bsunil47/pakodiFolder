<div class="content">
    <div class="module">
        <div class="module-head"> <h3>Edit Content Owner<span style="float:right; display: inline-block" class="back-close btn pakodi">Back</span></h3></div>
        <div class="module-body">
            <form id="updatecontentowner" name="updatecontentowner" method="post" action="<?php echo base_url(); ?>Admin/users/coupdate/<?php echo $users->id; ?>" class="form-horizontal row-fluid">
