        ...
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    <td align="right"><?php if(isset($dubs_file)){?><a href="http://sprintmediasg.s3.amazonaws.com/reports/<?php echo $dubs_file;?>" class='btn pakodi' >Export</a><?php }?><a href="javascript:window.history.go(-1);" style="float:right; display: inline-block" class="back-close btn pakodi">Back</a></td>
                </tr>
            </table>
