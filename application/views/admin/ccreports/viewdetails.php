    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left"><h3>User  Viewed  Report</h3></td>
                    <td align="right"><?php if (isset($views_file)) {?><a href="http://sprintmediasg.s3.amazonaws.com/reports/<?php  echo $views_file; ?>" class='btn pakodi'>Export</a><?php }?></td>
                </tr>
            </table>
