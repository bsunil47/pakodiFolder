<div class="content">
    <div class="module">
        <div class="module-head"> <h3>Move Audio Record<span style="float:right; display: inline-block" class="back-close btn pakodi">Back</span></h3></div>
...
<!--                    <label class="control-label" for="content_type">Content Type:</label>-->
                ...
                <div class="control-group">
                    <div class="controls">
						...
						<input type="submit" name="submit" id="submit" value="Move" class="btn pakodi">
