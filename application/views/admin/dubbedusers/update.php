        ...
        <div class="module-body">
            <form id="updatecontent" name="updatecontent" method="post" action="" class="form-horizontal row-fluid" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <img src="http://sprintmediasg.s3.amazonaws.com/dubs/<?php echo $userdubs->thumb_filename; ?>" border='0' alt='Thumb Image' width='100' height="100" />
                ...
                <div class="control-group" id="multipleupload">
                    ...
                    <video  height='150' controls ><source src='http://sprintmediasg.s3.amazonaws.com/dubs/<?php echo $userdubs->dubclip_filename;?>' type='video/mp4'></video>
					</div>
                </div>
                <div class="control-group">
