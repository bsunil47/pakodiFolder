                    ...
                    <div class="module-head">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td align="right"><?php if(isset($week_file)){?><a href="http://sprintmedia.s3.amazonaws.com/reports/<?php echo $week_file;?>?header=content-disposition:attachment;filename:<?php if(isset($week_file)){echo $week_file;}?>;" download="download" target="_blank" class='btn pakodi' >Export</a><?php }?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="module-head">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td align="right"><?php if(isset($year_file)){?><a href="http://sprintmedia.s3.amazonaws.com/reports/<?php echo $year_file;?>" class='btn pakodi' >Export</a><?php }?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="module-head">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td align="right"><?php if(isset($month_file)){?><a href="http://sprintmedia.s3.amazonaws.com/reports/<?php echo $month_file;?>" class='btn pakodi' >Export</a><?php }?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="clear"></div>
