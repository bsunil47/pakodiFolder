                    ...
                    <div class="module-head">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td align="right"><a href="http://sprintmedia.s3.amazonaws.com/reports/<?php if(isset($day_file)){echo $day_file;}?>?header=content-disposition:attachment;filename:<?php if(isset($day_file)){echo $day_file;}?>;" class='btn pakodi' target="_blank" download >Export</a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="clear"></div>
