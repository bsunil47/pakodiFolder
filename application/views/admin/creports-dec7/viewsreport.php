    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    <td align="right"><a
                            href="http://sprintmedia.s3.amazonaws.com/reports/<?php if (isset($views_file)) {
                                echo $views_file;
                            } ?>?header=content-disposition:attachment;filename:<?php if(isset($views_file)){echo $views_file;}?>;" class='btn pakodi' target="_blank" download >Export</a></td>
                </tr>
            </table>
        ...
        <div class="module-body table" style="border-bottom: 1px solid #d5d5d5;">
			...
			<div id="column4" style="float:left;width: 10%;">
				<input type="submit" name="contentsubmit" id="reportsubmit" value="Search" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;">
			</div>
