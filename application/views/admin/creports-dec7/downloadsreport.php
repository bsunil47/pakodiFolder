    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    <td align="right"><a href="http://sprintmedia.s3.amazonaws.com/reports/<?php if(isset($downloads_file)){echo $downloads_file;}?>?header=content-disposition:attachment;filename:<?php if(isset($downloads_file)){echo $downloads_file;}?>;" class='btn pakodi' target="_blank" download >Export</a></td>
                </tr>
            </table>
        ...
        <div class="module-body table" style="border-bottom: 1px solid #d5d5d5;">
			...
			<div id="column3" style="float:left;width: 28%;">
				<div class='input-group date' id='to_date'><input type='text' class="form-control" name="todate" id="todate" value="<?php if (!empty($_POST['todate'])) {
                                echo $_POST['todate'];} ?>" />
                            <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span></span></div>
			</div>
			<div id="column4" style="float:left;width: 10%;">
				<input type="submit" name="reportsubmit" id="reportsubmit" value="Search" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;">
				<!--input type="submit" name="reportsubmit" id="contentsubmit" value="Go" class="pakodi" style="margin-bottom: 10px;padding: 4px;"-->
			</div>
