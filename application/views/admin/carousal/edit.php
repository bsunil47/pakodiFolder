...
<div class="content" onload="testfunction()">
    <div class="module">
        <div class="module-head">
            <h3>Edit Carousal<a style="float:right; display: inline-block" class="back-close btn pakodi" href="javascript:window.history.go(-1);    ">Back</a></h3></div>
				...
				<div class="control-group" id="singleupload">
                     ...
                     <div class="controls">
					   ...
					   <?php
					    if($carouseledit->type == "image" && $carouseledit->is_clickable == 0)
					    {
					      ...
					      echo $image_path = "<img src='http://sprintmediasg.s3.amazonaws.com/appimages/".$path."' border='0' alt='image' width='60' height='40' />";
				 ...
				 <div class="control-group" id="multipleupload"  style="visibility:hidden;">
					...
					<?php	
					 ...
					 {
					  echo $image_path = "<img src='http://sprintmediasg.s3.amazonaws.com/appimages/".$path."' border='0' alt='image' width='100' height='50' style='float:left; padding:10px 10px 0 0;' />"; 
					  ...
					  echo $audio_path = "<audio src='http://sprintmediasg.s3.amazonaws.com/audios/".$path_audio."' width='0' height='30' controls ></audio>";
					 ...
					 else if($carouseledit->type == 'video' && $carouseledit->is_clickable == 1)
					 {
					  ...
					  echo $video_path  = "<video  width='0' height='150' controls ><source src='http://sprintmediasg.s3.amazonaws.com/videos/'".$path_video."' type='video/mp4'></video>";
					}
					?>
                    </div>
                </div>
