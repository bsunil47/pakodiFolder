        ...
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<td align="left"><h3>Ad Management</h3></td>
                                <td align="right"><a href="<?php echo base_url();?>Admin/carousal/add" class="btn pakodi">Add Carousal</a></td>
				</tr>
                ...
                <tbody>
                 <?php
                    ...
                    for ($i = 0; $i < count($carousel); $i++) {
						...
						if($type == "image" )
						{
						  $typenew = "<img src='http://sprintmediasg.s3.amazonaws.com/appimages/".$path."' border='0' alt='image' width='100' height='40' class='test'/>";	
						}
						else if($type == 'audio')
						{
						  ...
						  $typenew = "<audio src='http://sprintmediasg.s3.amazonaws.com/audios/".$path."' width='0' height='30' controls ></audio>";
						}
						else if($type == 'video')
						{
						  ...
						  $typenew = "<video src='http://sprintmediasg.s3.amazonaws.com/videos/".$path."' width='300' height='150' class='test' controls ></video>";
						}	
						...
						if($carousel[$i]->status == '1')
						{
							//$statusn = "Active";
								...
								$link = '<a href="' . base_url() .'Admin/carousal/carouselstatus/'. $carousel[$i]->car_id .'/'.$carousel[$i]->status.'"><i class="iconred icon-remove" title="Inactive"></i></a>';
						}
						else{
							//$statusn = "Inactive";
								$statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
								$link = '<a href="'. base_url().'Admin/carousal/carouselstatus/'.$carousel[$i]->car_id.'/'. $carousel[$i]->status.'"><i class="icongreen icon-ok" title="Active"></i></a>';
						}
                      ?>
                      <tr>
						 ...
						 <?php echo $link;?>
                            ...
                            <a href="<?php echo base_url(); ?>Admin/carousal/edit/<?php echo $carousel[$i]->car_id; ?>"><i class="iconred icon-pencil" title="Edit"></i></a>
