...
<!--                                <td align="left"><?php echo $status; ?></td>-->
                                <td align="left">
                                    <a <?php if(!empty($dubbedusers[$i]->dubclip_filename)){?>href="http://sprintmediasg.s3.amazonaws.com/dubs/<?php echo $dubbedusers[$i]->dubclip_filename;?>" <?php }?> download target="_blank">Download</a>&nbsp;&nbsp;
