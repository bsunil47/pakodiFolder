<div class="content">
    <div class="module">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
				<td align="left"><h3>Edit Rejected Records</h3></td>
        ...
        <div class="module-body">
            <form id="updatecontent" name="updatecontent" method="post" action="" class="form-horizontal row-fluid" enctype="multipart/form-data">
                ...
                <div class="control-group" id="multipleupload">
                    <label class="control-label" for="dubclip_filename">Dub Audio:</label>
                    <div class="controls">
					   ...
					   <audio src="http://sprintmediasg.s3.amazonaws.com/dubs/<?php echo $userdubs->dubclip_filename; ?>" width='0' height='150' controls ></audio><br>
                    </div>
                </div>
                <div class="control-group">
