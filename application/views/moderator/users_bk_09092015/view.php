            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%">
                ...
                <tbody>
                    ...
                    if (!empty($user)) {
                        ...
                        <?php if (!empty($user->profile_picture)) { ?><tr><th align="right">Profile Picture:</th><td align="left"><?php echo $user->profile_picture; ?></td></tr><?php } ?>
                        ...
                        <?php if (!empty($user->isfacebook_active)) { ?><tr><th align="right">Facebook Status:</th><td align="left"><?php if($user->isfacebook_active == 1){ echo 'Ative';}else{echo 'Inactive';} ?></td></tr><?php } ?>
                        <?php if (!empty($user->istwitter_active)) { ?><tr><th align="right">Twitter Status:</th><td align="left"><?php if($user->istwitter_active == 1){ echo 'Ative';}else{echo 'Inactive';} ?></td></tr><?php } ?>
                        <?php if (!empty($user->isgplus_active)) { ?><tr><th align="right">Google Plus Status:</th><td align="left"><?php if($user->isgplus_active == 1){ echo 'Ative';}else{echo 'Inactive';} ?></td></tr><?php } ?>
                        <?php if (!empty($user->iswhtatsapp_active)) { ?><tr><th align="right">Whatsapp Status:</th><td align="left"><?php if($user->iswhtatsapp_active == 1){ echo 'Ative';}else{echo 'Inactive';} ?></td></tr><?php } ?>
                        ...
                        <?php if (!empty($user->status)) { ?><tr><th align="right">Status:</th><td align="left"><?php if($user->status == 1){ echo 'Ative';}else{echo 'Inactive';} ?></td></tr><?php } ?>
