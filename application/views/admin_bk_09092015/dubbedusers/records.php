    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left"><h3>Records</h3></td>
               </tr>
            </table>
        </div>
        <div class="module-body table">
            ...
            <form name="date" method="post">
                ...
                <input type="button" name="recsubmit" id="recsubmit" value="Go">
                <input type="button" id="recreset" value="Reset">
            </form>
            
            <table cellpadding="0" cellspacing="0" border="0" class="datatable-12 table table-bordered table-striped display" width="100%">
                <thead>
                    <tr>
