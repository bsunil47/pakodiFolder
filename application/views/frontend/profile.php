            ...
            <form name="updateadmin" id="updateadmin" method="post" action="" class="form-horizontal row-fluid" enctype="multipart/form-data">
                ...
                <div class="control-group" id="imgupload">
                    ...
                    <div class="controls">
                       ...
                       <!--img src="<?php //echo base_url().'appimages/'.$users->profile_picture;?>" alt="photo" style="width:100px; height:100px;"-->
                    <img src='http://sprintmediasg.s3.amazonaws.com/userimages/<?php echo $users->profile_picture; ?>' border='0' alt='image' width='100' height='40' />
					</div>
                </div>

                <div class="control-group">
                    <div class="controls"><input type="submit" name="submit" value="Edit" class="btn pakodi" /></div>
                </div>
            </form>
        </div>
    </div>
