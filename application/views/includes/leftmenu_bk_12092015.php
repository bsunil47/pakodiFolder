...
<div class="sidebar">
    <ul class="widget widget-menu unstyled ">
        ...
        <?php if($this->session->userdata('admin_user_type')==0){?><li class= "<?php if ($this->router->fetch_class() == 'users' && ($this->router->fetch_method() == 'adminuserlist' ||  $this->router->fetch_method() == 'adupdate')) { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/users/adminuserlist"><i class="menu-icon icon-user"></i>Admin Users</a></li><?php }?>
