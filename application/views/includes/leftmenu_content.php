...
<div class="sidebar">
    <ul class="widget widget-menu unstyled ">
        ...
        <li class= "<?php if ($this->router->fetch_class() == 'content' && $this->router->fetch_method() == 'clist') { ?>active<?php } ?>"><a  href="<?php echo base_url(); ?>content/clist"><i class="menu-icon fa fa-file-text-o"></i>Content List</a></li>
       <li class= "<?php if ($this->router->fetch_class() == 'content' && $this->router->fetch_method() == 'contentupload') { ?>active<?php } ?>"><a href="<?php echo base_url(); ?>content/contentupload"><i class="menu-icon icon-arrow-up"></i>Create Job</a></li>
          <li class= "<?php if ($this->router->fetch_class() == 'content' ) { ?>active<?php } ?>"><a href="<?php echo base_url(); ?>zipfiles/sample.xls"><i class="menu-icon icon-arrow-down"></i>Sample excel file for download</a></li>
