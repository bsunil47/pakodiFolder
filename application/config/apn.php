...
/*
  ...
  |
 */
//$config['PermissionFile'] = FCPATH . 'apn/com.sprintapps.pakodi_APNS_Dev_CertNKey.pem';
// This is the PRODUCTION PEM file
//$config['PermissionFile'] = FCPATH . 'apn/com.sprintapps.pakodi_APNS_Dev_CertNKey.pem';

// This is the DEVELOPMENT PEM file
$config['PermissionFile'] = FCPATH . 'apn/PakodiDev_APNS_Development.pem';
