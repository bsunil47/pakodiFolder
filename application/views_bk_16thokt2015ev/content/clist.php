        ...
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    </td><td>&nbsp;&nbsp;<input type="button" name="search" id="clistsearch" value="Search" class="pakodi" style="margin-bottom: 10px;padding: 4px;">&nbsp;&nbsp;<input type="button" name="reset" id="clistreset" value="Reset" class="pakodi" style="margin-bottom: 10px;padding: 4px;"></td>
                </tr>
            </table>
        </div>
