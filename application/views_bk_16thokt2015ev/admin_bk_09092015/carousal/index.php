    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
				<td align="left"><h3>Carousal</h3></td>
				<td align="right"><a href="<?php base_url(); ?>carousal/add" >Add Carousal</a></td>
				</tr>
                ...
                <tbody>
                 <?php
                    ...
                    for ($i = 0; $i < count($carousel); $i++) {
						...
						if($type == "image" )
						{
						  $typenew = "<img src='http://sprintmedia.s3.amazonaws.com/appimages/".$path."' border='0' alt='image' width='100' height='40' />";	
						}
						else if($type == 'audio')
						{
						...
						else if($type == 'video')
						{
						  ...
						  $typenew = "<video src='http://sprintmedia.s3.amazonaws.com/videos/".$path."' width='300' height='150' controls ></video>";
						}	
                      ...
                      <tr>
                         ...
                         <td align="left">
                             ...
                             <a href="<?php echo base_url(); ?>Admin/carousal/carouselstatus/<?php echo $carousel[$i]->car_id; ?>/<?php echo $carousel[$i]->status; ?>"><button class="btn" title="Edit" style="border:1px solid #cccccc;">Status</button></a>
                             <a href="<?php echo base_url(); ?>Admin/carousal/edit/<?php echo $carousel[$i]->car_id; ?>"><button class="btn" title="Edit" style="border:1px solid #cccccc;">Edit</button></a>
