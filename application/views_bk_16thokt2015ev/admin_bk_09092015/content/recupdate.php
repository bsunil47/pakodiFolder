                ...
                <div class="control-group">
				    ...
				    <div class="controls" id="recfilter" <?php if($recommends->column_name == 'recommend_sort'){ ?>style="float:left;width:260px; margin-left:10px;display: none;" <?php }else{?>style="float:left;width:260px; margin-left:10px;display: block;"<?php } ?>>
                        <select tabindex="1" data-placeholder="Select here.." class="span8" name="recommend_filter" id="recommend_filter">
                            ...
                            <option  value="1 DAY" <?php  if($recommends->filter_interval == '1 DAY'){ echo  'selected="selected"'; } ?>>1 DAY</option>
							<option  value="2 DAY" <?php  if($recommends->filter_interval == '2 DAY'){ echo  'selected="selected"'; } ?>>2 DAY</option>
                            <option  value="3 DAY" <?php  if($recommends->filter_interval == '3 DAY'){ echo  'selected="selected"'; } ?>>3 DAY</option>
                            <option  value="4 DAY" <?php  if($recommends->filter_interval == '4 DAY'){ echo  'selected="selected"'; } ?>>4 DAY</option>
                            <option  value="5 DAY" <?php  if($recommends->filter_interval == '5 DAY'){ echo  'selected="selected"'; } ?>>5 DAY</option>
                            <option  value="6 DAY" <?php  if($recommends->filter_interval == '6 DAY'){ echo  'selected="selected"'; } ?>>6 DAY</option>
                        </select>
