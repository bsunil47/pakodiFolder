...
<div class="sidebar">
    <ul class="widget widget-menu unstyled ">
        ...
        <li><a class="<?php if ($this->router->fetch_class() != 'cms' || $this->router->fetch_class() != 'content' || $this->router->fetch_class() != 'dubbedusers' || ($this->router->fetch_class()!= 'settings') && ($this->router->fetch_class()!= 'content') && ($this->router->fetch_class()!= 'appversion') && ($this->router->fetch_class()!= 'category') && ($this->router->fetch_class()!= 'languages') || $this->fetch_class() !='flags') { ?>collapsed<?php } ?>" data-toggle="collapse" href="#togglePages5"><i class="menu-icon icon-desktop"></i>
              <i class="icon-chevron-down pull-right"></i><i class="icon-chevron-up pull-right"></i>CMS</a>
            <ul id="togglePages5" class="unstyled <?php if ($this->router->fetch_class() == 'cms' || $this->router->fetch_class() == 'content' || $this->router->fetch_class() =='dubbedusers' ||($this->router->fetch_class()!= 'settings') && ($this->router->fetch_class()!= 'content') && ($this->router->fetch_class()!= 'appversion') && ($this->router->fetch_class()!= 'category') && ($this->router->fetch_class()!= 'languages') || $this->fetch_class() !='flags') { ?>in<?php } ?> collapse">
                ...
                <!--contentlist start-->
                <li><a class="<?php if ($this->router->fetch_class() != 'cms' && $this->router->fetch_class()!= 'content' && $this->router->fetch_method() == 'recommend' || $this->router->fetch_method() == 'recupdate') { ?>collapsed<?php } ?>" data-toggle="collapse" href="#togglePages8"><i class="menu-icon icon-screenshot"></i>
           <!--<i class="icon-chevron-down pull-right"></i>--><i class="icon-chevron-up pull-right"></i>Content List</a>
            <ul id="togglePages8" class="unstyled <?php if (($this->router->fetch_class() == 'content' && $this->router->fetch_method() != 'recommend' && $this->router->fetch_method() != 'recupdate') || ($this->router->fetch_class()== 'content' && ($this->router->fetch_method() == 'update'))) { ?>in<?php } ?> collapse">
				...
				<li class= "<?php if ($this->router->fetch_class() == 'content' && ($this->router->fetch_method() == 'deletedcontentlist' || $this->router->fetch_method() == 'update' || $this->router->fetch_method() == 'view')) { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/content/deletedcontentlist"><i class="menu-icon icon-book"></i>Rejected Content</a></li>
 <li class= "<?php if ($this->router->fetch_class() == 'content' && ($this->router->fetch_method() == 'waitning' || $this->router->fetch_method() == 'add' || $this->router->fetch_method() == 'update' || $this->router->fetch_method() == 'view')) { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/content/waiting"><i class="menu-icon icon-book"></i>Waiting for Approval</a></li>
            </ul>
        </li>
        <!-- contentlist End-->
        <!-- UGC list start-->
        <li><a class="<?php if ($this->router->fetch_class() != 'cms' && $this->router->fetch_class() != 'dubbedusers') { ?>collapsed<?php } ?>" data-toggle="collapse" href="#togglePages6"><i class="menu-icon icon-film"></i>
             <!--<i class="icon-chevron-down pull-right"></i>--><i class="icon-chevron-up pull-right"></i>UGC Content</a>
            <ul id="togglePages6" class="unstyled <?php if ($this->router->fetch_class() == 'dubbedusers') { ?>in<?php } ?> collapse">
                <li class= "<?php if ($this->router->fetch_class() == 'dubbedusers' && ($this->router->fetch_method() == 'index' || $this->router->fetch_method() == 'update')) { ?>active<?php } ?>"><a  href="<?php echo base_url(); ?>Admin/dubbedusers"><i class="menu-icon icon-film"></i>Waiting for Moderation</a></li>
                <li class= "<?php if ($this->router->fetch_class() == 'dubbedusers' && ($this->router->fetch_method() == 'records' || $this->router->fetch_method() == 'recordupdate')) { ?>active<?php } ?>"><a  href="<?php echo base_url(); ?>Admin/dubbedusers/records"><i class="menu-icon icon-film"></i>Audio Records</a></li>
           <li class= "<?php if ($this->router->fetch_class() == 'dubbedusers' && ($this->router->fetch_method() == 'deleteddubs' || $this->router->fetch_method() == 'dubdelupdate')) { ?>active<?php } ?>"><a  href="<?php echo base_url(); ?>Admin/dubbedusers/deleteddubs"><i class="menu-icon icon-film"></i>Rejected Dubs</a></li>
            <li class= "<?php if ($this->router->fetch_class() == 'dubbedusers' && ($this->router->fetch_method() == 'deletedrecords' || $this->router->fetch_method() == 'dubdelrecupdate')) { ?>active<?php } ?>"><a  href="<?php echo base_url(); ?>Admin/dubbedusers/deletedrecords"><i class="menu-icon icon-film"></i>Rejected Records</a></li>
                <li class= "<?php if ($this->router->fetch_class() == 'dubbedusers' && ($this->router->fetch_method() == 'ugc' || $this->router->fetch_method() == 'update')) { ?>active<?php } ?>"><a  href="<?php echo base_url(); ?>Admin/dubbedusers/ugc"><i class="menu-icon icon-film"></i>UGC Category</a></li>
            </ul>
        </li>
        <!--UGC list End-->
        <li class= "<?php if ($this->router->fetch_class() == 'carousal') { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/carousal"><i class="menu-icon icon-facetime-video"></i>Ad Management</a></li>
        <!-- Settings start--> 
        <li><a class="<?php if ($this->router->fetch_class() != 'cms' && ($this->router->fetch_class()!= 'settings') && ($this->router->fetch_class()!= 'content') && ($this->router->fetch_class()!= 'appversion') && ($this->router->fetch_class()!= 'category') && ($this->router->fetch_class()!= 'languages')) { ?>collapsed<?php } ?>" data-toggle="collapse" href="#togglePages7"><i class="menu-icon icon-screenshot"></i>
            ...
            <ul id="togglePages7" class="unstyled <?php if (($this->router->fetch_class() == 'settings') || ($this->router->fetch_class()== 'content' && ($this->router->fetch_method() == 'recommend' || $this->router->fetch_method() == 'recupdate' )) || ($this->router->fetch_class()== 'appversion') || ($this->router->fetch_class()== 'category') || ($this->router->fetch_class()== 'languages')) { ?>in<?php } ?> collapse">
				...
				<li class= "<?php if ($this->router->fetch_class() == 'content' && ($this->router->fetch_method() == 'recommend'|| $this->router->fetch_method() == 'recupdate')) { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/content/recommend"><i class="menu-icon icon-comments"></i>Sample Window</a></li>
        ...
        <li class= "<?php if ($this->router->fetch_class() == 'reports') { ?>active<?php } ?>" ><a href="<?php echo base_url(); ?>Admin/reports"><i class="menu-icon icon-envelope"></i>Feedback</a></li>
