    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left"><h3>Rejected Dubs</h3></td>
               </tr>
            </table>
        </div>
        <div class="module-body table">
            ...
            <form name="date" method="post">
                ...
                <input type="button" name="delsubmit" id="delsubmit" value="Go" class="pakodi" style="margin-bottom: 10px;padding: 4px;">
                <input type="button" id="delreset" value="Reset" class="pakodi" style="margin-bottom: 10px;padding: 4px;">
            </form>
