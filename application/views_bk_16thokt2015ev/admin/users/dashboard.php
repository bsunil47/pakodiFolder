            ...
            <div class="module span12" style="width:800px;">
				...
				<div style="padding:5px;">
                    ...
                    <div id="show2" class="hidz">
                        ...
                        <input type="button" id="btn_month" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;" value="Go" onclick="return getusersbymonthly();">
                    </div>
                    <div id="show3" class="hidz" style="display: block;">
                        ...
                        <input type="button" id="btn_week" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;" value="Go" onclick="return getusersbyweekly();">
                    </div>
                    <div id="show4" class="hidz">
                        ...
                        <input type="button" id="btn_day" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;" value="Go" onclick="return getusersbydaily();">
                    </div>
                </form>
            ...
            <div class="module span12" style="width:800px;">
				...
				<div style="padding:5px;">
                    ...
                    <div id="dshow2" class="hidz">
                        ...
                        <input type="button" id="btn_month" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;" value="Go" onclick="return getdubsbymonthly();">
                    </div>
                    <div id="dshow3" class="hidz" style="display: block;">
                        ...
                        <input type="button" id="btn_week" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;" value="Go" onclick="return getdubsbyweekly();">
                    </div>
                    <div id="dshow4" class="hidz">
                        ...
                        <input type="button" id="btn_day" class="btn pakodi" style="margin-bottom: 10px;padding: 4px;" value="Go" onclick="return getdubsbydaily();">
                    </div>
                </form>
