<div class="content">
    <div class="module">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
				<td align="left"><h3>Edit User dubs</h3></td>
                                <td align="right"><a href="https://translate.google.co.in/" target="_blank"  class="btn pakodi">Google Translater link</a></td>
				</tr>
        ...
        <div class="module-body">
            <form id="updatecontent" name="updatecontent" method="post" action="" class="form-horizontal row-fluid" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <img src="http://sprintmedia.s3.amazonaws.com/dubs/<?php echo $userdubs->thumb_filename; ?>" border='0' alt='Thumb Image' width='100' height="100" />
                ...
                <div class="control-group" id="multipleupload">
                    ...
                    <div class="controls">
                       ...
                       <!--<iframe src="http://sprintmedia.s3.amazonaws.com/videos/<?php //echo $userdubs->dubclip_filename; ?>" width="450" height="250"></iframe>-->
					   <!--<video src="http://sprintmedia.s3.amazonaws.com/dubs/<?php echo $userdubs->dubclip_filename; ?>" width='0' height='150' controls ></video><br>-->
                    <video  height='150' controls ><source src='http://sprintmedia.s3.amazonaws.com/dubs/<?php echo $userdubs->dubclip_filename;?>' type='video/mp4'></video>
					</div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
					...
					<input type="submit" name="submit" id="submit" value="Edit" class="btn pakodi">
                        <?php //echo form_submit('submit', 'Edit', 'id="submit"', 'name="submit"', 'class="btn pakodi"'); ?>
