    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td align="left"><h3>Rejected Records</h3></td>
               </tr>
            </table>
        </div>
        <div class="module-body table">
            ...
            <form name="date" method="post">
                ...
                <input type="button" name="delrecsubmit" id="delrecsubmit" value="Go" class="pakodi" style="margin-bottom: 10px;padding: 4px;">
                <input type="button" id="delrecreset" value="Reset" class="pakodi" style="margin-bottom: 10px;padding: 4px;">
            </form>
