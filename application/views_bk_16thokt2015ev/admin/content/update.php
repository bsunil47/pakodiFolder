        ...
        <div class="module-body">
            <form id="updatecontent" name="updatecontent" method="post" action="" class="form-horizontal row-fluid" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo form_input('dialog_writer0', $content[0]->dialog_writer, 'id="dialog_writer", class="span8" placeholder="Enter Dialog writer Name" autocomplete="off"'); ?>
                ...
                <div class="control-group">
                    <label class="control-label" for="dialog_writer">Dialog Writer:</label>
                    <div class="controls">
                        <?php echo form_input('dialog_writer1', $content[1]->dialog_writer, 'id="dialog_writer", class="span8" placeholder="Enter Dialog writer Name" autocomplete="off"'); ?>
