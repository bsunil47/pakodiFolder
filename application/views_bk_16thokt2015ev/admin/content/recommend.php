    ...
    <div class="module">
        <div class="module-head">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr><td align="left"><h3>Sample window</h3></td>
				 </tr>
             </table>
        </div>
                 ...
                 ?>
                      <tr>
                         ...
                         <td align="left">
                             ...
                             <a href="<?php echo base_url(); ?>Admin/content/recupdate/<?php echo $recommends[$i]->rec_id; ?>"><button class="btn pakodi" title="Edit" style="border:1px solid #cccccc;">Edit</button></a>
