        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
                ...
                if ($status == 1) {
					...
					$link = '<a href="' . base_url() . 'moderator/users/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="iconred icon-remove" title="Status"></i></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else  {
                    $statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
					$link = '<a href="' . base_url() . 'moderator/users/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;';
                }
                $row[7] = $statusn;
            ...
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
               ...
               // $row[3] = "<img src='$path' width='50' height='auto' class='test'>";
				...
				//$row[4]  = "<audio width='50' height='auto' controls><source src='$apath'></audio>";
                                $row[4] = '<i class="iconred icon-play play-content" title="Play"  data-media="'.$aRow['dubclip_filename'].'"></i>';
                ...
                if ($status == 1) {
                    $statusn = '<i class="icongreen icon-ok" title="Active"></i>';
					$link = '<a href="' . base_url() . 'moderator/users/updaterecstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="iconred icon-remove" title="Status"></i></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else {
                    $statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
					$link = '<a href="' . base_url() . 'moderator/users/updaterecstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;';
                }
                $row[7] = $statusn;
    ...
    public function getUData(){
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 1) {
                ...
                if ($status == 1) {
                    $statusn = '<i class="icongreen icon-ok" title="Active"></i>';
					$link = '<a href="' . base_url() . 'moderator/users/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="iconred icon-remove" title="Status"></i></a>&nbsp;';
                    //} else if ($status == 0 || $status == '' || $status == "NULL") {
                } else {
                   	$statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
					$link = '<a href="' . base_url() . 'moderator/users/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;';
                }
                $row[7] = $statusn;
