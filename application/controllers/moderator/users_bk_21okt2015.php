    ...
    public function getData() { 
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
                ...
                $row[3] = "<img src='$path' width='50' height='50' class='test'>";
                ...
                if ($status == 1) {
					...
					$link = '<a href="' . base_url() . 'moderator/users/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">InActive</button></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
					...
					$link = '<a href="' . base_url() . 'moderator/users/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">Active</button></a>&nbsp;';
                }
                $row[7] = $statusn;
                ...
                //$row[] = '<a href="' . base_url() . 'moderator/users/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                   $row[] = $link.'<a href="' . base_url() . 'moderator/users/update/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;';
//                        . '<a href="' . base_url() . 'moderator/users/movedubs/' . $aRow['dub_id'] . '"><button class="btn" title="move" style="border:1px solid #cccccc;">Move</button></a>';
                $output['aaData'][] = $row;
        }
    }  
	...
	public function getRData() { 
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
                ...
                if ($status == 1) {
                    $statusn = "<button class='btn-success' title='Active' style='border:0px solid #cccccc;'>Active</button>";
					$link = '<a href="' . base_url() . 'moderator/users/updaterecstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">InActive</button></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else {
                    $statusn = "<button class='btn-danger' title='Inactive' style='border:0px solid #cccccc;'>Inactive</button>";
					$link = '<a href="' . base_url() . 'moderator/users/updaterecstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">Active</button></a>&nbsp;';
                }
                $row[7] = $statusn;
                ...
                //$row[8] = '<a href="' . base_url() . 'moderator/users/updaterecstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                   $row[8] = $link.'<a href="' . base_url() . 'moderator/users/recordupdate/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;'
                        . '<a href="' . base_url() . 'moderator/users/moverecord/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="move" style="border:1px solid #cccccc;">Move</button></a>';
                $output['aaData'][] = $row;
        }
    }
        if($this->input->get_post('sSearch')){
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
                ...
                $i = $i + 1;
               	...
               	$row[7] = '<a href="' . base_url() . 'moderator/users/dubdelupdate/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;';
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
                ...
                $i = $i + 1;
               	...
               	$row[7] = '<a href="' . base_url() . 'moderator/users/dubdelrecupdate/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;';
    ...
    public function getUData(){
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 1) {
                ...
                if ($status == 1) {
                    $statusn = "<button class='btn-success' title='Active' style='border:0px solid #cccccc;'>Active</button>";
					$link = '<a href="' . base_url() . 'moderator/users/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">InActive</button></a>&nbsp;';
                    //} else if ($status == 0 || $status == '' || $status == "NULL") {
                } else {
                    $statusn = "<button class='btn-danger' title='Inactive' style='border:0px solid #cccccc;'>Inactive</button>";
					$link = '<a href="' . base_url() . 'moderator/users/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">Active</button></a>&nbsp;';
                }
                $row[7] = $statusn;
