...
class Frontend extends My_Controller {
    ...
    public function __construct() {
        //$allowed_methodes = array('index', 'changepassword', 'content','createjob','terms');
		$allowed_methodes = array('index', 'forgotpassword', 'forgot_changepassword', 'profile');
        parent::__construct();
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (!empty($result)) {
                    ...
                    if (!empty($result_s)) {
                        ...
                        $this->session->set_userdata('co_name', $result->name);
                        $this->session->set_userdata('co_msisdn', $result->msisdn);
                        $this->session->set_userdata('co_email', $result->email);
                        $this->session->set_userdata('co_user_type', $result_s->user_type);
                        $this->session->set_userdata('co_profile_picture', $result->profile_picture);
   ...
   public function logout() {
        ...
        $this->session->unset_userdata('co_name');
        $this->session->unset_userdata('co_msisdn');
        $this->session->unset_userdata('co_email');
        $this->session->unset_userdata('co_user_type');
        $this->session->unset_userdata('co_profile_picture');
