	...
	public function getData() { 
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
                ...
                $row[3] = "<img src='$path' width='80' height='80' class='test'>";
				
				$apath = "http://sprintmedia.s3.amazonaws.com/dubs/" . $aRow['dubclip_filename'];
				$row[4]  = "<video width='100' height='100'  class='test' poster='{$path}' controls><source src='$apath' type='video/mp4'></video>";
                ...
                if ($status == 1) {
					...
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">InActive</button></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
					...
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">Active</button></a>&nbsp;';
                }
                $row[7] = $statusn;
                ...
                //$row[] = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                  $row[] = $link.'<a href="' . base_url() . 'Admin/dubbedusers/update/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;';
	...
	public function getRData() { 
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
				...
				$row[2] =$aRow['dubclip_title'];
				$path = "http://sprintmedia.s3.amazonaws.com/dubs/" . $aRow['thumb_filename'];
                $row[3] = "<img src='$path'  class='test' width='80' height='80'>";
				 
				$apath = "http://sprintmedia.s3.amazonaws.com/dubs/" . $aRow['dubclip_filename'];
				$row[4]  = "<audio width='100' height='100' controls><source src='$apath'></audio>";
                ...
                if ($status == 1) {
                    $statusn = "<button class='btn-success' title='Active' style='border:0px solid #cccccc;'>Active</button>";
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">InActive</button></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else {
                    $statusn = "<button class='btn-danger' title='Inactive' style='border:0px solid #cccccc;'>Inactive</button>";
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">Active</button></a>&nbsp;';
                }
                $row[7] = $statusn;
                ...
                //$row[8] = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                 $row[8] = $link.'<a href="' . base_url() . 'Admin/dubbedusers/recordupdate/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;'
                        . '<a href="' . base_url() . 'Admin/dubbedusers/moverecord/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="move" style="border:1px solid #cccccc;">Move</button></a>';
                $output['aaData'][] = $row;
        }
    }
        if($this->input->get_post('sSearch')){
	...
	public function getMData() { //echo "hello";
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
                ...
                //. 
						$row[7] = '<a href="' . base_url() . 'Admin/dubbedusers/dubdelupdate/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;';
    ...
    public function getNData() { //echo "hello";
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
                ...
                $i = $i + 1;
				$row[6] = $aRow['datecreated'];
                $row[7] = '<a href="' . base_url() . 'Admin/dubbedusers/dubdelrecupdate/' . $aRow['dub_id'] . '"><button class="btn pakodi" title="update" style="border:1px solid #cccccc;">Update</button></a>&nbsp;&nbsp;';
//                        . '<a href="' . base_url() . 'Admin/dubbedusers/movedeldub/' . $aRow['dub_id'] . '"><button class="btn" title="move" style="border:1px solid #cccccc;">Move</button></a>';
                $output['aaData'][] = $row;
        }
    } 
    ...
    public function getUData(){
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 1) {
                ...
                if ($status == 1) {
                    $statusn = "<button class='btn-success' title='Active' style='border:0px solid #cccccc;'>Active</button>";
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">InActive</button></a>&nbsp;&nbsp;';
                    //} else if ($status == 0 || $status == '' || $status == "NULL") {
                } else {
                    $statusn = "<button class='btn-danger' title='Inactive' style='border:0px solid #cccccc;'>Inactive</button>";
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn pakodi" title="status" style="border:1px solid #cccccc;">Active</button></a>&nbsp;&nbsp;';
                }
                $row[7] = $statusn;
