        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
                ...
                if ($status == 1) {
					...
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="iconred icon-remove" title="Status"></i></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else  {
                    $statusn = '<i class="iconred icon-remove" title="Inactiveewe"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;';
                }
                $row[7] = $statusn;
                ...
                //$row[] = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                  $row[] = $link.'<a href="' . base_url() . 'Admin/dubbedusers/update/' . $aRow['dub_id'] . '"><i class="iconred icon-pencil" title="Edit"></i></a>&nbsp;&nbsp;<a href="' . base_url() . 'Admin/dubbedusers/rejectdub/' . $aRow['dub_id'] . '"><i class="iconred icon-thumbs-down" title="Reject"></i></a>&nbsp;&nbsp;';
	...
	public function getRData() { 
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
				...
				$row[3]='<div class="tric"><img src="http://sprintmedia.s3.amazonaws.com/appimages/'.$aRow["thumb_filename"].'" class="test" width="50" height="auto"><div class="redo"><b>'.$aRow['clip_length'].' S'.'</b></div></div>';
				 
				$apath = "http://sprintmedia.s3.amazonaws.com/dubs/" . $aRow['dubclip_filename'];
				//$row[4]  = "<audio width='50' height='auto' controls><source src='$apath'></audio>";
				$row[4] = '<i class="iconred icon-play play-content" title="Play"  data-contenttype="3" data-media="'.$aRow['dubclip_filename'].'"></i>';
                ...
                if ($status == 1) {
                 	$statusn = '<i class="icongreen icon-ok" title="Active"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-remove" title="Status"></i></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else {
                    $statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;';
                }
                $row[7] = $statusn;
                ...
                //$row[8] = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                 $row[8] = $link.'<a href="' . base_url() . 'Admin/dubbedusers/recordupdate/' . $aRow['dub_id'] . '"><i class="iconred icon-pencil" title="Edit"></i></a>&nbsp;&nbsp;'
                        . '<a href="' . base_url() . 'Admin/dubbedusers/moverecord/' . $aRow['dub_id'] . '"><i class="iconred icon-move" title="Move"></i></a>&nbsp;&nbsp;<a href="' . base_url() . 'Admin/dubbedusers/rejectrecord/' . $aRow['dub_id'] . '"><i class="iconred icon-thumbs-down" title="Reject"></i></a>';
                $output['aaData'][] = $row;
        }
    }
        if($this->input->get_post('sSearch')){
	...
	public function getMData() { //echo "hello";
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
                ...
                //. 
						$row[7] = '<a href="' . base_url() . 'Admin/dubbedusers/dubdelupdate/' . $aRow['dub_id'] . '"><i class="iconred icon-pencil" title="Edit"></i></a>&nbsp;&nbsp;';
    ...
    public function getNData() { //echo "hello";
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
                ...
                $i = $i + 1;
				$row[6] = $aRow['datecreated'];
                $row[7] = '<a href="' . base_url() . 'Admin/dubbedusers/dubdelrecupdate/' . $aRow['dub_id'] . '"><i class="iconred icon-pencil" title="Edit"></i></a>&nbsp;&nbsp;';
//                        . '<a href="' . base_url() . 'Admin/dubbedusers/movedeldub/' . $aRow['dub_id'] . '"><button class="btn" title="move" style="border:1px solid #cccccc;">Move</button></a>';
                $output['aaData'][] = $row;
        }
    } 
    ...
    public function getUData(){
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 1) {
                ...
                if ($status == 1) {
                    $statusn = '<i class="icongreen icon-ok" title="Active"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="iconred icon-remove" title="Status"></i></a>&nbsp;&nbsp;';
                    //} else if ($status == 0 || $status == '' || $status == "NULL") {
                } else {
                    $statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;&nbsp;';
                }
                $row[7] = $statusn;
