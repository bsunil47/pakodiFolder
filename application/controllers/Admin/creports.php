...
(SELECT count(MC.language_id) as languagecount, MC.content_status, l.language FROM `tbl_master_content` as MC JOIN `tbl_languages` as l ON `MC`.`language_id`=`l`.`lang_id` WHERE MC.content_status <> 1 {$daterange} GROUP BY (MC.language_id) ORDER BY `l`.`lang_id` desc)");
			...
			$data_array_catlang=$this->common_model->pureQuery("(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 1 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 1 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 2 {$daterange} AND MC.content_status = 1  and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 2 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 3 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 3 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 4 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 4 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 5 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 5 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 6 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 6 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 7 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 7 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 8 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 8 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 9 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 9 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 10 {$daterange} AND MC.content_status = 1 and MC.language_id = '1' GROUP BY (MC.language_id))
UNION
(SELECT count(MC.master_content_id) as mastr_cat_count, MC.category_id,MC.content_status,l.language,c.category,c.cat_id from tbl_master_content as MC JOIN tbl_languages as l ON MC.language_id=l.lang_id JOIN tbl_categories as c ON MC.category_id=c.cat_id where MC.category_id = 10 {$daterange} AND MC.content_status <> 1 and MC.language_id = '1' GROUP BY (MC.language_id))");
...
");	
    ...
    private function userviewsreport($year,$where_query){
        ...
        $select="U.name,MC.unique_code,C.title,MC.thumb_filename,MC.contentclip_filename,MC.clip_length,MC.content_type";
