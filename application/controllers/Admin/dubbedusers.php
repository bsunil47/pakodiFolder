...
class Dubbedusers extends My_Controller {
	...
	public function getData() { 
        ...
        if(!empty($_POST['sSearch_0']) && !empty($_POST['sSearch_1'])){
       	...
       	$where = "D.dub_status = '1' AND D.record_type = '1' AND D.isdub_moderate = '0'".$daterange;
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
				...
				$row[4]  = "<video width='50' height='auto'  class='test2' poster='{$path}' controls><source src='$apath' type='video/mp4'></video>";
                ...
                if ($status == 1) {
					...
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="iconred icon-remove" title="Inactive"></i></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else  {
                    $statusn = '<i class="iconred icon-remove" title="Inactiveewe"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Active"></i></a>&nbsp;';
                }
                $row[7] = $statusn;
                ...
                //$row[] = '<a href="' . base_url() . 'Admin/dubbedusers/updatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                  $row[] = $link.'<span class="open-div" data-url="' . base_url() . 'Admin/dubbedusers/update/' . $aRow['dub_id'] . '" title="Edit"><i class="iconred icon-pencil" title="Edit"></i></span>&nbsp;&nbsp;<a href="' . base_url() . 'Admin/dubbedusers/rejectdub/' . $aRow['dub_id'] . '"><i class="iconred icon-thumbs-down" title="Reject"></i></a>&nbsp;&nbsp;';
	...
	public function getRData() { 
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
				...
				$row[2] =$aRow['dubclip_title'];
				$path = "http://sprintmediasg.s3.amazonaws.com/dubs/" . $aRow['thumb_filename'];
                //$row[3] = "<img src='$path'  class='test' width='50' height='auto'>";
				...
				$row[4] = '<i class="iconred fa fa-play-circle-o play-content" title="Play"  data-contenttype="3" data-media="'.$aRow['dubclip_filename'].'"></i>';
                ...
                if ($status == 1) {
                 	$statusn = '<i class="icongreen icon-ok" title="Active"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-remove" title="Inactive"></i></a>&nbsp;';
                //} else if ($status == 0 || $status == '' || $status == "NULL") {
				} else {
                    $statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Active"></i></a>&nbsp;';
                }
                $row[7] = $statusn;

                //$row[8] = '<a href="' . base_url() . 'Admin/dubbedusers/updaterecordstatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
                 $row[8] = $link.'<span class="open-div" data-url="' . base_url() . 'Admin/dubbedusers/recordupdate/' . $aRow['dub_id'] . '" title="Edit"><i class="iconred icon-pencil" title="Edit"></i></span>&nbsp;&nbsp;'
                        . '<span class="open-div" data-url="' . base_url() . 'Admin/dubbedusers/moverecord/' . $aRow['dub_id'] . '" title="Move"><i class="iconred icon-move" title="Move"></i></span>&nbsp;&nbsp;<a href="' . base_url() . 'Admin/dubbedusers/rejectrecord/' . $aRow['dub_id'] . '"><i class="iconred icon-thumbs-down" title="Reject"></i></a>';
                $output['aaDatspan class="open-div" data-url'][] = $row;
        }
    }
        if($this->input->get_post('sSearch')){
            $output['iTotalRecords'] = $count;
	...
	public function getMData() { //echo "hello";
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 0) {
				...
				$apath = "http://sprintmediasg.s3.amazonaws.com/dubs/" . $aRow['dubclip_filename'];
				//$row[4]  = "<video width='100' height='100'  class='test' controls><source src='$apath' type='video/mp4'></video>";
                ...
                //. 
						$row[7] = '<span class="open-div" data-url="' . base_url() . 'Admin/dubbedusers/dubdelupdate/' . $aRow['dub_id'] . '" title="Edit"><i class="iconred icon-pencil" title="Edit"></i></span>&nbsp;&nbsp;';
    ...
    public function getNData() { //echo "hello";
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 2 && $aRow['isdub_moderate'] == 0) {
                ...
                $i = $i + 1;
				$row[6] = $aRow['datecreated'];
                $row[7] = '<span class="open-div" data-url="' . base_url() . 'Admin/dubbedusers/dubdelrecupdate/' . $aRow['dub_id'] . '" title="Edit"><i class="iconred icon-pencil" title="Edit"></i></span>&nbsp;&nbsp;';
//                        . '<a href="' . base_url() . 'Admin/dubbedusers/movedeldub/' . $aRow['dub_id'] . '"><button class="btn" title="move" style="border:1px solid #cccccc;">Move</button></a>';
                $output['aaData'][] = $row;
        }
    } 
	...
	public function ugcupdatestatus($id, $status) {
        ...
        if($result_update == 0){
            $this->setFlashmessage('success', 'Updated Successfully');
            redirect(base_url() . "Admin/dubbedusers/ugc");
            }
    }
    ...
    public function getUData(){
        ...
        $where = "D.dub_status = '1' AND D.record_type = '1' AND D.isdub_moderate = '1'".$daterange;
        $data = $this->common_model->getTable($aColumns, $where,'dub_id');
        $output = $data['output'];
        //print_r($output); exit;
        $count = 0;
        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['record_type'] == 1 && $aRow['isdub_moderate'] == 1) {
                ...
                //$row[5] = "<video src='$apath' width='0' height='150' controls ></video>";
				$apath = "http://sprintmediasg.s3.amazonaws.com/dubs/" . $aRow['dubclip_filename'];
				$row[4]  = "<video width='50' height='auto' class='test' poster='{$path}' controls><source src='$apath' type='video/mp4'></video>";
                ...
                if ($status == 1) {
                    $statusn = '<i class="icongreen icon-ok" title="Active"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="iconred icon-remove" title="Inactive"></i></a>&nbsp;&nbsp;';
                    //} else if ($status == 0 || $status == '' || $status == "NULL") {
                } else {
                    $statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
					$link = '<a href="' . base_url() . 'Admin/dubbedusers/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><i class="icongreen icon-ok" title="Active"></i></a>&nbsp;&nbsp;';
                }
                $row[7] = $statusn;
                //$row[] = '<a href="' . base_url() . 'Admin/dubbedusers/ugcupdatestatus/' . $aRow['dub_id'] . '/' . $aRow['dub_status'] . '"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;';
                $row[] = $link;
				$output['aaData'][] = $row;
            }
        }
