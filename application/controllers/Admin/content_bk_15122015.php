...
class Content extends My_Controller {
    ...
    public function getData() { //echo "I am in getdata method";
        ...
        foreach ($data['result'] as $aRow) {
			...
			$row[0] = '<a href="' . base_url() . 'Admin/content/view/' . $aRow['master_content_id'] . '">'.$aRow["unique_code"].'</a>';
			$row[1] = $aRow['title'];
            $i = $i + 1;
            ...
            if($aRow['content_type']==2){
                $typenew = "<audio src='http://sprintmedia.s3.amazonaws.com/audios/".$aRow['contentclip_filename']."'  width='50' height='auto' controls ></audio>";
                
            }else if($aRow['content_type']==1){
                $typenew = "<video src='http://sprintmedia.s3.amazonaws.com/videos/".$aRow['contentclip_filename']."' class='test' width='50' height='auto' controls ></video>";
            }
            //$row[3] =$typenew;
            ...
            if ($status == 1) {
				...
				$link='<a href="' . base_url() . 'Admin/content/contentstatus/' . $aRow['master_content_id'] . '/' . $aRow['content_status'] . '"><i class="iconred icon-remove" title="Status"></i></a>&nbsp;';
            } else if ($status == 0 || $status == '' || $status == "NULL") {
                $statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
				$link='<a href="' . base_url() . 'Admin/content/contentstatus/' . $aRow['master_content_id'] . '/' . $aRow['content_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;';
            }
            ...
            $row[7] = $link.'<a href="' . base_url() . 'Admin/content/update/' . $aRow['master_content_id'] . '"><i class="iconred icon-pencil" title="Edit"></i></a>'
                    . '&nbsp;&nbsp;<a href="' . base_url() . 'Admin/content/view/' . $aRow['master_content_id'] . '"><i class="iconred icon-eye-open" title="View"></i></a>'
                    .'<i class="iconred icon-table report-content" title="Reports"  data-sharecount="' . $aRow['contentshare_count'] . '" data-downloadcount="' . $aRow['contentdownload_count'] . '" data-viewcount="' . $aRow['contentplay_count'] . '" data-dubscount="' . $dubcount->cnt . '"></i>'.'&nbsp;<i class="iconred icon-play play-content" title="Play" data-contenttype="'.$aRow['content_type'].'" data-media="'.$aRow['contentclip_filename'].'"></i>';
					$output['aaData'][] = $row;
        }
	...
	$language_id ="";
        ...
        foreach ($data['result'] as $aRow) {
			...
			$row[2] = '<div class="tric"><img src="http://sprintmedia.s3.amazonaws.com/appimages/'.$aRow["thumb_filename"].'" class="test" width="50" height="auto"><div class="redo"><b>'.$aRow['clip_length'].' S'.'</b></div></div>';
            if($aRow['content_type']==2){
                $typenew = "<audio src='http://sprintmedia.s3.amazonaws.com/audios/".$aRow['contentclip_filename']."'  controls ></audio>";
            ...
            if ($status == 2) {
				...
				$statusn = '<i class="iconred icon-remove" title="Inactive"></i>';
				$link = '<a href="' . base_url() . 'Admin/content/delcontentstatus/' . $aRow['master_content_id'] . '/' . $aRow['content_status'] . '"><i class="icongreen icon-ok" title="Status"></i></a>&nbsp;';
				...
				$statusn = '<i class="icongreen icon-ok" title="Active"></i>';
				$link = '<a href="' . base_url() . 'Admin/content/delcontentstatus/' . $aRow['master_content_id'] . '/' . $aRow['content_status'] . '"><i class="iconred icon-remove" title="Status"></i></a>&nbsp;';
            }
            $row[5] = $statusn;

            $row[6] = $link.'<a href="' . base_url() . 'Admin/content/update/' . $aRow['master_content_id'] .'/deletedcontentlist'. '"><i class="iconred icon-pencil" title="Edit"></i></a>'
			. '&nbsp;&nbsp;<a href="' . base_url() . 'Admin/content/view/' . $aRow['master_content_id'] . '"><i class="iconred icon-eye-open" title="View"></i></a>'.'&nbsp;<i class="iconred icon-play play-content" title="Play" data-contenttype="'.$aRow['content_type'].'" data-media="'.$aRow['contentclip_filename'].'">';
            $output['aaData'][] = $row;
        }
        echo json_encode($output);
    }
...
//        }
        ...
        foreach ($data['result'] as $aRow) {
            ...
            if($aRow['content_type']==2){
                ...
                $typenew = "<video src='http://sprintmedia.s3.amazonaws.com/videos/".$aRow['contentclip_filename']."' class='test' width='50' height='auto' controls ></video></a>";
            }
            $row[3] ='<i class="iconred icon-play play-content" title="Play" style="padding:25px;" data-contenttype="'.$aRow['content_type'].'" data-media="'.$aRow['contentclip_filename'].'">';
            $row[4] = '-';
            if ($aRow['content_activationdate'] != '0000-00-00' && $aRow['content_activationdate'] != NULL) {
                $actdate = new DateTime($aRow['content_activationdate']);
