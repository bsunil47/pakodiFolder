        ...
        foreach ($data['result'] as $aRow) {
            if ($aRow['contentowner_id'] == $this->session->userdata['user_id']) {
               ...
               //$row[2] = "<img src='$path' width='50' height='auto' class='test'>";
                $row[2] = '<div class="tric test"><img src="http://sprintmediasg.s3.amazonaws.com/appimages/'.$aRow["thumb_filename"].'"  width="50" height="auto"><div class="redo"><b>'.$aRow['clip_length'].' S'.'</b></div></div>'; 
// $expdate = new DateTime($aRow['content_expirydate']);
                ...
                if ($aRow['content_type'] == 2) {
                    ...
                    $row[3] ='<i class="iconred fa fa-play-circle-o play-content" title="Play" data-contenttype="'.$aRow['content_type'].'" data-media="'.$aRow['contentclip_filename'].'"></i>';
                    //$row[4]='testing';
