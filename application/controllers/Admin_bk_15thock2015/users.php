...
//Active and Register Users statistics(Weekly)
    ...
    public function getData() {
        ...
        foreach ($data['result'] as $aRow) {
                ...
                $row[] = '<a href="' . base_url() . 'Admin/users/userstatus/' . $aRow['id'] . '/' . $aRow['status'] . '/userlist"><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;&nbsp;'
    ...
    public function adminuserlist()
    {
     ...
     public function getAdData() {
        ...
        foreach ($data['result'] as $aRow) {
                ...
                $row[] = '<a href="' . base_url() . 'Admin/users/userstatus/' . $aRow['id'] . '/' . $aRow['status'] .'/adminuserlist "><button class="btn" title="status" style="border:1px solid #cccccc;">Status</button></a>&nbsp;'
                . '<a href="' . base_url() . 'Admin/users/adupdate/' . $aRow['id'] . '"><button class="btn" title="Edit" style="border:1px solid #cccccc;">Edit</button></a>';
                $output['aaData'][] = $row;
