...
class Notification_model extends CI_Model {
    ...
    public function __construct() {
        ...
        $this->apnsDir = FCPATH . 'application/third_party/ApnsPHP/';
        $this->_apns_req();
        return;
    }
    ...
    public function send_ios($token = null, $msg = null, $attrs = array()) {
        ...
        $push = new ApnsPHP_Push(
                ApnsPHP_Abstract::ENVIRONMENT_SANDBOX, $this->apnsDir . 'SSL/com.bloo.ichek.pem'
        );

        // Set the Provider Certificate passphrase
        $push->setProviderCertificatePassphrase('ichek@123');
        echo $this->apnsDir . 'SSL/com.bloo.ichek.pem';
        // Set the Root Certificate Autority to verify the Apple remote peer
        //$push->setRootCertificationAuthority($this->apnsDir . 'SSL/com.bloo.ichek.pem');
        echo 'sada';
