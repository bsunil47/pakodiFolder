...
<div class="content">
    <div class="module">
        <div class="module-head"> <h3>Edit User dubs</h3></div>
        <div class="module-body">
            <form id="updatecontent" name="updatecontent" method="post" action="" class="form-horizontal row-fluid" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <img src="<?php echo base_url(); ?>appimages/<?php echo $userdubs->thumb_filename; ?>" border='0' alt='Thumb Image' width='100' height="100" />
